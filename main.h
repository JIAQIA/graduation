...
#include "data_deal_def.h"//雕刻机数据定义
...
extern void auto_ctrl(void) ;
static void TIM3_Config(void) ;

//U盘读取---------------------------------------------------------
#if defined MEDIA_USB_KEY
  /* You can change the Wave file name as you need, but do not exceed 11 characters */
  #define MECH_NAME "0:mech.txt"
  #define USER_NAME "0:user.txt"
  #define CODE_NAME "0:code.txt"
  #define REC_WAVE_NAME "0:02.txt"
